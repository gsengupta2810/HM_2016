...
// @vimicro add customized extension unit structure
// @vimicro add IOCTL for customized extension unit control
struct vm_ext_unit
{
        __u32    cmdType; //1--chip command; 2--sensor command; 3--I2c command;
        __u32    opType;  //1--read; 2--write;
        __u32    address;
        __u32    value;
	__u32	 iiaddr;
};
...
#define VIDIOC_EU_CTRL  _IOWR('V', 80, struct vm_ext_unit)
